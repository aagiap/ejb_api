...
public class CertificateV1Controller {
    ...
    public ApiResponse<Map<String, Object>> getExpiredCert(@RequestParam(defaultValue = "false") Integer days,
                                                           ...
                                                           @RequestParam(defaultValue = "false") Integer maxNumberOfResults) {
    ...
    public ApiResponse<Map<String, Object>> revoke(@PathVariable String issuer_dn,
                                                   ...
                                                   @RequestParam(required = false) String invalidity_date) {
    ...
    @PostMapping("/search")
    public ApiResponse<Map<String, Object>> searchCertificate(@RequestBody Map<String, Object> searchCertificateRequest) {
    ...
    @PostMapping("/enroll")
    public ApiResponse<Map<String, Object>> enrollCertificate(@RequestBody EnrollRequest enrollRequest) {
    ...
    public ApiResponse<Map<String, Object>> finalizeEnroll(@PathVariable String request_id,
                                                           @RequestBody FinalizeEnrollRequest finalizeEnrollRequest) {
    ...
    public ApiResponse<Map<String, Object>> enrollKeyStore(@RequestBody EnrollKeyStoreRequest enrollKeyStoreRequest) {
        return certificateV1Service.enrollKeyStore(enrollKeyStoreRequest);
    }

    // Enroll for a certificate given a PEM encoded PKCS#10 CSR.
    @PostMapping("/certificate-request")
    public ApiResponse<Map<String, Object>> certificateRequest(@RequestBody CertificateRequest certificateRequest) {
